...
USER_AGENT = "srn-docs/1.0 (offline docs mirror; +https://straion.com/robots.txt allows all)"
...
def build_llms_txt(entries: dict[str, dict], sections: list[dict]) -> str:
    ...
    out = [
        "# Straion",
        "",
        "> Offline mirror of straion.com generated by srn-docs/sync.py from the",
...
def build_llms_full(entries: dict[str, dict], out_dir: Path, sections: list[dict]) -> str:
    ...
    parts = [
        ...
        "",
        "Generated by srn-docs/sync.py from https://straion.com/sitemap-index.xml",
